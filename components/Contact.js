                ...
                <div className="lg:flex lg:flex-wrap g-0">
                  ...
                  >
                    <div className="text-white px-4 py-6 md:p-12 md:mx-6">
                      ...
                      <div
                     className=" max-w-[60px]sm:max-w-[70px]w-full h-[60px] sm:h-[70px] flex items-center justify-center mr-6  overflow-hidden
                  ...
                  <div className="w-full">
                     ...
                     Stand No.463 Sandton Industrial Park, Westgate, Harare, Zimbabwe.
                     </p>
                  </div>
                  </div>
                  ...
                  <div className="w-full">
                     ...
                     <p className="text-base text-body-color">+263 78 577 4848</p>
                     <p className="text-base text-body-color">+263 242371101</p>
                  </div>
               </div>
