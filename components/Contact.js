              ...
              <div className="block bg-white shadow-lg rounded-lg">
                <div className="lg:flex lg:flex-wrap g-0">
                  ...
                  >
                    <div className="text-white px-4 py-6 md:p-12 md:mx-6">
                      ...
                      <div
                     class=" max-w-[60px]sm:max-w-[70px]w-full h-[60px] sm:h-[70px] flex items-center justify-center mr-6  overflow-hidden
                  ...
                  <div class="w-full">
                     ...
                     <p class="text-base text-body-color">+263 772 340 505</p>
                  </div>
               </div>
               ...
               <div class="flex mb-8 max-w-[370px] w-full">
                  ...
                  <div class="w-full">
                     ...
                     <p class="text-base text-body-color">info@chitaitai.com</p>
                  </div>
               </div>
