...
import dishw from '../public/dish.jpg'
import dishw1 from '../public/dish1.jpg'
    ...
    <div>
        ...
        <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-8 lg:px-6">
            <div className="mx-auto mb-8 max-w-screen-sm lg:mb-8">
                <h2 className="md:mb-16 my-8 text-4xl tracking-tight font-extrabold text-red-500 dark:text-white">Dish Washer</h2>
                </div> 
            <div className="grid gap-8 lg:gap-16 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                
                <div className="text-center text-red-500  dark:text-red-500 ">
                <Image src={dishw} height={140} width={170} alt="dish washer"/>
                ...
                <div className="text-center text-red-500  dark:text-red-500 ">
                <Image src={dishw1} height={140} width={170} alt="dish washer"/>
                    <h3 className="mb-1 py-2 text-2xl font-bold tracking-tight text-red-500  dark:text-white">
                        750 ml
                    </h3>
